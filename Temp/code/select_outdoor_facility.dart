...
class _SelectOutdoorFacilityState extends State<SelectOutdoorFacility> {
  ...
  void initState() {
    ...
    _selectedIdsList.addListener(() {
      for (var element in _selectedIdsList.value) {
                ...
                onPressed: () {
                  if (!isButtonDisabled) {
                    ...
                    if (_formKey.currentState!.validate()) {
                      log("HuyTBQ CRUD: throw parameters to CreatePropertyCubit: $parameters");
                      bool hasMediaUpload =
                          parameters.containsKey("gallery_images") ||
                              parameters.containsKey("title_image");
                    ...
                    // Disable button for waiting upload
                  }
                },
    ...
    return Row(
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: context.color.teritoryColor.withValues(alpha: 0.1),
            borderRadius: BorderRadius.circular(10),
          ),
          child: FittedBox(
              fit: BoxFit.none,
