  <div id="page-detail">
    ...
    <div class="detail-scroll" id="detailScroll">
      ...
      <div class="detail-section" id="detailFacilitiesSection" style="display:none;">
        <div class="detail-section-header" onclick="toggleSection(this)">
          <div class="detail-section-title"><span style="display:inline-flex;align-items:center;gap:5px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg> Tiện ích xung quanh</span></div>
          <span class="detail-section-toggle open">▾</span>
        </div>
        <div class="detail-section-body">
      ...
      <div class="detail-section" id="detailDescSection" style="display:none;">
        ...
        <div class="detail-section-body">
          ...
          <button class="read-more-btn" id="readMoreBtn" onclick="toggleReadMore()" style="display:none;">Xem thêm ▾</button>
        </div>
      </div>
      ...
      <div class="detail-section role-broker role-bds_admin role-sale role-sale_admin role-admin" id="detailLegalSection">
        ...
        <div class="detail-section-body">
          ...
          <div id="detailLegalEmpty" style="font-size:12px;color:var(--text-tertiary);padding:4px 0;">Chưa có thông tin pháp lý</div>
        </div>
      </div>

      <!-- VỊ TRÍ — hidden when no coordinates, Broker+ only -->
      <div class="detail-section role-broker role-bds_admin role-sale role-sale_admin role-admin" id="detailLocationSection" style="display:none;">
        <div class="detail-section-header" onclick="toggleSection(this)">
        ...
        <div class="detail-section-body">
          <div class="map-preview" id="detailMapPreview">
            ...
            <div id="mapIframeContainer" style="position:absolute;inset:0;border-radius:var(--radius-md);overflow:hidden;display:none;"></div>
            <!-- transparent click overlay (sits above iframe, opens Google Maps) -->
            <div id="mapClickOverlay" onclick="openGoogleMaps()" style="position:absolute;inset:0;z-index:2;display:none;cursor:pointer;"></div>
            ...
            <div class="map-preview-label" style="z-index:3;">
              <span style="display:inline-flex;align-items:center;gap:3px;">
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
                <span id="mapAddrLabel">Đà Lạt</span>
                &nbsp;·&nbsp;
                <a id="mapLink" href="#" target="_blank" style="color:var(--primary);font-weight:600;display:inline-flex;align-items:center;gap:3px;">
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
                  Xem bản đồ
                </a>
              </span>
            </div>
    ...
    <div id="bookingFormOverlay" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:650;align-items:flex-end;justify-content:center;">
      <div style="background:var(--bg-card);border-radius:20px 20px 0 0;padding:8px 0 32px;width:100%;max-width:430px;">
        ...
        <div style="padding:16px 20px;">
          ...
          <div style="font-size:13px;font-weight:600;color:var(--text-primary);margin-bottom:14px;padding:10px 12px;background:var(--bg-secondary);border-radius:var(--radius-sm);" id="bookingPropName">--</div>
    ...
    <div class="send-modal">
      ...
      <div id="dealPickList">
        <div class="deal-pick-item" onclick="selectDeal(this,1)">
          ...
          <div><div class="deal-pick-name">Anh Minh Tuấn</div><div class="deal-pick-meta">Deal #1 · Tìm Đất ở · 1–2 tỷ · P.Cam Ly</div></div>
        ...
        <div class="deal-pick-item" onclick="selectDeal(this,2)">
          ...
          <div><div class="deal-pick-name">Chị Thu Hà</div><div class="deal-pick-meta">Deal #2 · Tìm Nhà phố · 1.5–3 tỷ · P.Cam Ly</div></div>
