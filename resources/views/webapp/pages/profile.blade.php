...
<div class="page" id="page-profile">
  ...
  <div class="profile-stats">
    ...
    <div class="ps-item">
      <div class="ps-val">{{ $stats['deals_count'] ?? 0 }}</div>
      <div class="ps-lbl">Giao dịch</div>
    </div>
    <div class="ps-item">
      <div class="ps-val">{{ $stats['reviews_count'] ?? 0 }} <svg width="13" height="13" viewBox="0 0 24 24"
          fill="#fbbf24" stroke="#fbbf24" stroke-width="1.5" style="vertical-align:middle;">
          <polygon
            points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
        </svg></div>
      <div class="ps-lbl">Yêu cầu</div>
    </div>
  </div>
  ...
  <div class="role-broker">
    <div class="menu-section">
      <div class="menu-section-title">Quản lý BĐS</div>
    </div>
    <div class="menu-item" onclick="openSubpage('mybds')">
      <div class="menu-item-icon"
        style="background:var(--primary-light);display:flex;align-items:center;justify-content:center;"><svg width="18"
      ...
      <div class="menu-item-body">
        ...
        <div class="menu-item-sub">{{ $stats['my_total_count'] ?? 0 }} tin · {{ $stats['my_pending_count'] ?? 0 }} chờ
          duyệt</div>
      </div>
      <div class="menu-item-right">@if(($stats['my_pending_count'] ?? 0) > 0)<span
      class="badge badge-amber">{{ $stats['my_pending_count'] }} chờ duyệt</span> @endif ›</div>
    </div>
    <div class="menu-item" onclick="openSubpage('mycustomers')">
      <div class="menu-item-icon"
        style="background:var(--teal-light);display:flex;align-items:center;justify-content:center;"><svg width="18"
          height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"
          stroke-linejoin="round">
  ...
  <div class="role-sale">
    <div class="menu-section">
      <div class="menu-section-title">CRM — Chăm sóc khách hàng</div>
    </div>
    <div class="menu-item" style="border-left:3px solid var(--primary);" onclick="openSubpage('clients')">
      <div class="menu-item-icon"
        style="background:var(--primary-light);display:flex;align-items:center;justify-content:center;"><svg width="18"
          height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"
          stroke-linejoin="round">
    ...
    <div class="menu-item" onclick="openSubpage('leads')">
      ...
      <div class="menu-item-body">
        ...
        <div class="menu-item-sub">{{ $stats['leads_count'] ?? 0 }} lead</div>
      </div>
      <div class="menu-item-right">›</div>
    </div>
    <div class="menu-item" onclick="openSubpage('deals')">
      <div class="menu-item-icon"
        style="background:var(--purple-light);display:flex;align-items:center;justify-content:center;"><svg width="18"
          height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"
          stroke-linejoin="round">
          <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
          <circle cx="9" cy="7" r="4" />
      ...
      <div class="menu-item-body">
        ...
        <div class="menu-item-sub">{{ $stats['deals_count'] ?? 0 }} deal</div>
      </div>
      <div class="menu-item-right">›</div>
    </div>
    <div class="menu-item" onclick="openSubpage('bookings')">
      ...
      <div class="menu-item-body">
        ...
        <div class="menu-item-sub">Xem lịch xem BĐS</div>
      </div>
      <div class="menu-item-right">›</div>
    </div>
    <div class="menu-item" onclick="openSubpage('commissions')">
      ...
      <div class="menu-item-body">
        ...
        <div class="menu-item-sub">{{ $stats['commission_total_fmt'] ?? '0 đ' }} dự kiến ·
          {{ $stats['commission_deals'] ?? 0 }} deal
        </div>
      </div>
      <div class="menu-item-right">›</div>
    </div>
  ...
  <div class="role-bds_admin">
    <div class="menu-section">
      <div class="menu-section-title"><span style="display:inline-flex;align-items:center;gap:5px;"><svg width="14"
            height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"
            stroke-linejoin="round">
            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
            <polyline points="9 22 9 12 15 12 15 22" />
          </svg> Quản lý khu vực BĐS</span></div>
    </div>
    <div class="menu-item" style="border-left:3px solid var(--danger);" onclick="openSubpage('approvebds')">
      ...
      <div class="menu-item-right">@if(($stats['pending_count'] ?? 0) > 0)<span
      class="badge badge-red">{{ $stats['pending_count'] }}</span> @endif ›</div>
    </div>
  </div>
  ...
  <div class="role-sale_admin">
    <div class="menu-section">
      <div class="menu-section-title">Quản lý Team Sale</div>
    </div>
    <div class="menu-item" onclick="openSubpage('kpiteam')">
      <div class="menu-item-icon" style="background:#fef3c7;display:flex;align-items:center;justify-content:center;">
      ...
      <div class="menu-item-body">
        ...
        <div class="menu-item-sub">Theo dõi hiệu quả team</div>
      </div>
      <div class="menu-item-right">›</div>
    </div>
  ...
  <div class="role-admin">
    <div class="menu-section">
      <div class="menu-section-title"><span style="display:inline-flex;align-items:center;gap:5px;"><svg width="14"
            ...
            <polygon
              points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
          </svg> Quản trị hệ thống</span></div>
    </div>
    <div class="menu-item" onclick="openSubpage('users')">
      ...
      <div class="menu-item-body">
        ...
        <div class="menu-item-sub">Broker & khách hàng</div>
      </div>
      <div class="menu-item-right">›</div>
    </div>
    <div class="menu-item" onclick="openSubpage('reports')">
      <div class="menu-item-icon"
        style="background:var(--success-light);display:flex;align-items:center;justify-content:center;"><svg width="18"
          height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"
          stroke-linejoin="round">
    ...
    <div class="menu-item" onclick="openSubpage('approvecomm')">
      ...
      <div class="menu-item-body">
        ...
        <div class="menu-item-sub">Xác nhận thanh toán hoa hồng</div>
      </div>
      <div class="menu-item-right">›</div>
    </div>
    <div class="menu-item" onclick="openSubpage('activitylog')">
      <div class="menu-item-icon" style="background:#f0f9ff;display:flex;align-items:center;justify-content:center;">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#0284c7" stroke-width="1.7"
          stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="menu-item" onclick="openSubpage('marketprices')">
      <div class="menu-item-icon" style="background:#fef9c3;display:flex;align-items:center;justify-content:center;">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ca8a04" stroke-width="1.7"
          stroke-linecap="round" stroke-linejoin="round">
          <line x1="18" y1="20" x2="18" y2="10" />
          <line x1="12" y1="20" x2="12" y2="4" />
          <line x1="6" y1="20" x2="6" y2="14" />
          <polyline points="1 4 1 20 23 20" />
        </svg>
      </div>
      <div class="menu-item-body">
  ...
  <div class="menu-section" style="margin-top:8px;">
    <div class="menu-section-title"><span style="display:inline-flex;align-items:center;gap:5px;"><svg width="14"
        ...
        </svg> Mạng lưới giới thiệu</span></div>
  </div>
  ...
  <div class="menu-section" style="margin-top:8px;">
    <div class="menu-section-title">BĐS yêu thích</div>
  </div>
  <div class="menu-item" onclick="openSubpage('likedbds')">
    <div class="menu-item-icon"
      style="background:var(--primary-light);display:flex;align-items:center;justify-content:center;">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="var(--primary)" stroke="var(--primary)" stroke-width="1.7"
        stroke-linecap="round" stroke-linejoin="round">
        <path
    ...
    <div class="menu-item-body">
      ...
      <div class="menu-item-sub">{{ $stats['favourites_count'] ?? 0 }} BĐS đã lưu</div>
    </div>
    <div class="menu-item-right">›</div>
  </div>
  ...
  <div class="menu-item" onclick="openSubpage('editprofile')">
    <div class="menu-item-icon"
      style="background:var(--bg-secondary);display:flex;align-items:center;justify-content:center;"><svg width="18"
        height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"
        stroke-linejoin="round">
    ...
    <div class="menu-item-body">
      <div class="menu-item-title">Chỉnh sửa hồ sơ</div>
    </div>
    <div class="menu-item-right">›</div>
  </div>
  <div class="menu-item" onclick="openSubpage('notifset')">
    ...
    <div class="menu-item-body">
      <div class="menu-item-title">Cài đặt thông báo</div>
    </div>
    <div class="menu-item-right">›</div>
  </div>
  <div class="menu-item" onclick="openSubpage('support')">
    ...
    <div class="menu-item-body">
      <div class="menu-item-title">Hỗ trợ & FAQ</div>
    </div>
    <div class="menu-item-right">›</div>
  </div>
  <div class="menu-item" style="margin-bottom:8px;"
    onclick="if(confirm('Bạn có chắc muốn đăng xuất?')) window.location.href='/webapp/logout'">
    <div class="menu-item-icon"
      style="background:var(--danger-light);display:flex;align-items:center;justify-content:center;"><svg width="18"
        height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"
        stroke-linejoin="round">
    ...
    <div class="menu-item-body">
      <div class="menu-item-title" style="color:var(--danger);">Đăng xuất</div>
    </div>
