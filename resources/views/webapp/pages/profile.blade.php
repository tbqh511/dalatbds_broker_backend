...
<div class="page" id="page-profile">
  ...
  <div class="profile-hero">
    ...
    <div style="display:flex;gap:8px;margin-top:8px;align-items:center;">
      <div class="profile-role"><span style="display:inline-flex;align-items:center;gap:4px;"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/></svg> {{ $roleLabel }}</span></div>
  ...
  <div class="profile-stats">
    ...
    <div class="ps-item">
      <div class="ps-val">{{ $stats['reviews_count'] ?? 0 }} <svg width="13" height="13" viewBox="0 0 24 24" fill="#fbbf24" stroke="#fbbf24" stroke-width="1.5" style="vertical-align:middle;"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></div>
  ...
  <div class="role-sale">
    ...
    <div class="menu-item" onclick="openSubpage('clients')">
      <div class="menu-item-icon" style="background:var(--teal-light);display:flex;align-items:center;justify-content:center;"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div>
      <div class="menu-item-body">
        <div class="menu-item-title">Khách hàng</div>
        <div class="menu-item-sub">{{ ($stats['leads_count'] ?? 0) + ($stats['deals_count'] ?? 0) }} khách</div>
      </div>
      <div class="menu-item-right">›</div>
    </div>
    ...
    <div class="menu-item" onclick="openSubpage('commissions')">
      ...
      <div class="menu-item-body">
        ...
        <div class="menu-item-sub">{{ $stats['commission_total_fmt'] ?? '0 đ' }} dự kiến · {{ $stats['commission_deals'] ?? 0 }} deal</div>
      </div>
      <div class="menu-item-right">›</div>
    </div>
  ...
  <div class="menu-item" style="margin-bottom:8px;" onclick="if(confirm('Bạn có chắc muốn đăng xuất?')) window.location.href='/webapp/logout'">
