                ...
                <div class="grid grid-cols-4 gap-2 mb-6">
                    <template x-for="am in amenitiesList" :key="am.id">
                        <button type="button"
                            ...
                            <img :src="am.image.includes('http') ? am.image : '/images/facility_img/' + am.image" class="w-8 h-8 object-contain mb-1 filter" :class="isAmenitySelected(am.id) ? 'brightness-0 invert' : ''">
                    ...
                    <template x-for="(dist, id) in formData.amenities" :key="id">
                        <div class="flex items-center bg-white border border-gray-200 rounded-xl p-2 pr-4 shadow-sm animate-fade-in-up">
                            ...
                            <div class="w-8 h-8 rounded-lg bg-blue-50 text-primary flex items-center justify-center mr-3 flex-shrink-0 p-1">
                                ...
                                <img :src="getAmenityImage(id).includes('http') ? getAmenityImage(id) : '/images/facility_img/' + getAmenityImage(id)" class="w-full h-full object-contain">
                            </div>
