    ...
    <article class="geodir-category-listing fl-wrap">
        <div class="geodir-category-img fl-wrap">
            ...
            <div class="geodir-category-location">
                <a href="{{ route('property.show', ['slug' => $productCard->slug]) }}">
                    <i class="fas fa-map-marker-alt"></i>
                    <span>{{ $productCard->address_location }}</span>
                </a>
            </div>
                ...
                <ul>
                    ...
                    @if ($productCard->number_room)
                        <li>
                            ...
                            <span>{{ number_format((float) $productCard->number_room) }}</span>
                        </li>
                    @endif
                    @if ($productCard->number_floor)
                        <li>
                            <i class="fas fa-layer-group"></i>
                            <span>{{ number_format((float) $productCard->number_floor) }}</span>
                        </li>
                    @endif
                </ul>
            </div>
            <div class="geodir-category-footer fl-wrap">
                <a href="{{ route('agent.show', ['id' => $productCard->added_by]) }}" class="gcf-company">
                ...
                <div class="listing-rating card-popup-rainingvis tolt" data-microtip-position="top" data-tooltip="Good" data-starrating2="5"></div>
            </div>
        </div>
    </article>
</div>
