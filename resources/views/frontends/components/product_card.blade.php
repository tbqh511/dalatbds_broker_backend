<div class="listing-item">
    <article class="geodir-category-listing fl-wrap">
        <div class="geodir-category-img fl-wrap">
                <a href="{{ route('property.show', ['id' => $productCard->id]) }}" class="geodir-category-img_item">
                    <img src="{{$productCard->title_image}}" alt="">
                    <div class="overlay"></div>
                </a>
                <div class="geodir-category-location">
                    <a href="{{ route('property.show', ['id' => $productCard->id]) }}"><i class="fas fa-map-marker-alt"></i>
                        <span>
        ...
        <div class="geodir-category-content fl-wrap">
            <h3 class="title-sin_item">
                <a href="{{ route('property.show', ['id' => $productCard->id]) }}">{{ $productCard->title }}</a>
            </h3>
